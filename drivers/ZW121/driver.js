 ...
 */
Homey.manager('flow').on('action.zw121_from_to', (callback, args) => {
 ...
 */
Homey.manager('flow').on('action.zw121_rainbow', (callback, args) => {
	if (args && args.device && args.device.token && args.speed && args.fadeType && args.cycles) {
 ...
 */
Homey.manager('flow').on('action.zw121_random', (callback, args) => {
	if (args && args.device && args.device.token && args.speed && args.fadeType && args.cycles) {
